...
from core.integrations.defaults import (
    default_extract_resume_text,
...
class Resume(models.Model):
    ...
    resume = models.FileField(
        upload_to=resume_file_path, validators=[validate_pdf_file]
    )
    ...
    def process_summarization(self):
        ...
        if extracted_text:
            ...
            Resume.objects.filter(id=self.id).update(summary=f"{name} \n\n {summary}")
